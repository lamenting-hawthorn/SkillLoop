from skillloop.eval.registry import EvaluatorRegistry, RegisteredEvaluator, default_evaluator_registry
...
def test_registry_fills_missing_evaluator_identity():
    ...
    def fake(trace: AgentTrace) -> Evaluation:
        return Evaluation(trace_id=trace.id, score=1, evaluator_name="unknown", evaluator_version="0")
